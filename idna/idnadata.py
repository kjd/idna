...
scripts = {
	...
	'Common': frozenset(
		...
		list(range(0x2701,0x2800)) +
		list(range(0x2900,0x2b4d)) +
		list(range(0x2b50,0x2b5a)) +
		list(range(0x2e00,0x2e3c)) +
	...
	'Cyrillic': frozenset(
		...
		list(range(0x487,0x528)) +
		[0x1d2b] +
		[0x1d78] +
		list(range(0x2de0,0x2e00)) +
		list(range(0xa640,0xa698)) +
		[0xa69f]
	),
	'Deseret': frozenset(
	...
	'Latin': frozenset(
		...
		list(range(0xa790,0xa794)) +
		list(range(0xa7a0,0xa7ab)) +
		list(range(0xa7f8,0xa800)) +
...
codepoint_classes = {
	'PVALID': frozenset(
		...
		list(range(0x1b80,0x1bab)) +
		list(range(0x1bae,0x1bba)) +
		list(range(0x1bc0,0x1bf4)) +
		list(range(0x1c00,0x1c38)) +
		list(range(0x1c40,0x1c4a)) +
		list(range(0x1c4d,0x1c7e)) +
		list(range(0x1cd0,0x1cd3)) +
		list(range(0x1cd4,0x1cf3)) +
	...
	'DISALLOWED': frozenset(
		...
		list(range(0x2000,0x200c)) +
		list(range(0x200e,0x2065)) +
		list(range(0x206a,0x2072)) +
		list(range(0x2074,0x208f)) +
		list(range(0x2090,0x209d)) +
		list(range(0x20a0,0x20ba)) +
		list(range(0x20d0,0x20f1)) +
		...
		list(range(0x2440,0x244b)) +
		list(range(0x2460,0x2700)) +
		list(range(0x2701,0x27cb)) +
		[0x27cc] +
		list(range(0x27ce,0x2b4d)) +
		list(range(0x2b50,0x2b5a)) +
		list(range(0x2c00,0x2c2f)) +
		[0x2c60] +
		...
		list(range(0xfa2a,0xfa2e)) +
		list(range(0xfa30,0xfa6e)) +
		list(range(0xfa70,0xfada)) +
		list(range(0xfb00,0xfb07)) +
		list(range(0xfb13,0xfb18)) +
		[0xfb1d] +
		...
		list(range(0x1f500,0x1f53e)) +
		list(range(0x1f550,0x1f568)) +
		list(range(0x1f5fb,0x1f600)) +
		list(range(0x1f601,0x1f611)) +
		list(range(0x1f612,0x1f615)) +
		[0x1f616] +
		[0x1f618] +
		[0x1f61a] +
		list(range(0x1f61c,0x1f61f)) +
		list(range(0x1f620,0x1f626)) +
		list(range(0x1f628,0x1f62c)) +
		[0x1f62d] +
		list(range(0x1f630,0x1f634)) +
		list(range(0x1f635,0x1f641)) +
		list(range(0x1f645,0x1f650)) +
		list(range(0x1f680,0x1f6c6)) +
		list(range(0x1f700,0x1f774)) +
