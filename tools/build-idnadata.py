...
def print_optimised_list(d):
    # XXX pending a full conversion to unicode_literals, explicitly mark
    # the packed lists, and only them, as bytestrings.
    print('PackedIntSet(b' + repr(pack_int_list(d)) + '),')
